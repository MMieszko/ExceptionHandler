...
namespace ExceptionHandler.Tests
{
    ...
    {        
        ...
        public async Task CanGetResponseViaHandlerCreatedByReflection()
        {
            ...
            ApplicationBuilder.RegisterExceptionHandler().Catch<InvalidOperationException>().AndReturnAsync((context, exception) => Task.FromResult(new Response(statusCode, message)));
